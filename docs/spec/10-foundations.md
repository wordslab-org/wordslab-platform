...
ADR-0001 (contract) · 0002 (template + learning bar) · 0003 (core + bootstrap) · 0004 (topology) · 0005 (resources) · 0006 (providers + privacy) · 0007 (composition) · 0008 (registry) · 0013 (spec anatomy) · 0015 (dashboard guidance) · 0021 (backup / onboarding) · **0024 (this chapter's learning-experience governing ADR — bar, assistant, guided build, onboarding)** · 0020 (eval destination) · 0022 (license of model-backed steps).
