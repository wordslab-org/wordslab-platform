...
**Status:** accepted (resolution of wayfinder ticket "Define the service template & contribution surface"); amends ADR-0001 (base contract item 9, callable surfaces); **amended by ADR-0004** (implementations layer; heavy-dependency coordination)
