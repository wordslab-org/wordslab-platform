...
- **Publishing (#21) + Governance (#15) form a single combined service** — publishing moves off the Development service's surface, and governance (the catalog of all solutions built/run on the platform, with the documentation and monitoring to check compliance) joins it. The combined **Publishing & Governance** service is a candidate 13th, chapter `33-publishing-governance.md`. Content → #15, #21; catalog note → #18.
