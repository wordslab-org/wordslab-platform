...
- **`20-concerns/25-lifecycle-and-updates.md` spec chapter** — created with this ADR (installer + updates + backup tri-section; installer from ADR-0014, updates from ADR-0016, backup from this ADR).
...
- **Creates** `docs/architecture/20-concerns/25-lifecycle-and-updates.md` (backup section; installer + updates filled).
